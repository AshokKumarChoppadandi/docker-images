...
sed -i -e "s/CONNECT_CONFIGS_TOPIC/$CONNECT_CONFIGS_TOPIC/" /usr/local/confluent-5.3.3/config/connect-avro-distributed.properties
sed -i -e "s/CONNECT_OFFSETS_TOPIC/$CONNECT_OFFSETS_TOPIC/" /usr/local/confluent-5.3.3/config/connect-avro-distributed.properties
sed -i -e "s/CONNECT_STATUSES_TOPIC/$CONNECT_STATUSES_TOPIC/" /usr/local/confluent-5.3.3/config/connect-avro-distributed.properties
sed -i -e "s/CONFIG_STORAGE_REPLICATION_FACTOR/$CONFIG_STORAGE_REPLICATION_FACTOR/" /usr/local/confluent-5.3.3/config/connect-avro-distributed.properties
sed -i -e "s/OFFSET_STORAGE_REPLICATION_FACTOR/$OFFSET_STORAGE_REPLICATION_FACTOR/" /usr/local/confluent-5.3.3/config/connect-avro-distributed.properties
sed -i -e "s/STATUS_STORAGE_REPLICATION_FACTOR/$STATUS_STORAGE_REPLICATION_FACTOR/" /usr/local/confluent-5.3.3/config/connect-avro-distributed.properties
